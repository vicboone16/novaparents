...
-- Server-side recomputation of integrity_score and billing_eligible
-- Prevents client-side manipulation of billing eligibility
...
CREATE TRIGGER trg_compute_snapshot_scores
